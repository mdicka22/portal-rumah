const CACHE_NAME='portal-rumah-v1';
const APP_SHELL=['./','./index.html','./app.js','./styles.css','./login-blend.css','./ios-pwa.css','./assets/login-interior-coral.png','./assets/portal-rumah-icon.svg'];
